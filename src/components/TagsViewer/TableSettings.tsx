...
import { orderAtom, pageAtom, pageSizeAtom } from "src/store/viewerAtoms";

import type { Option } from "src/components/common/Select";
...
export const TableSettings = (props: TablePagesProps) => {
  ...
  const orderOptions: Option<Order | Sortable>[] = [
    {
      value: "asc",
      label: "ascending",
    },
  ...
  const sortingOptions: Option<Order | Sortable>[] = [
    {
      value: "asc",
      label: "ascending",
    },
